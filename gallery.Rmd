...
### Ordered Facet Plot
- [Inspired by Julia Silge's blog post](https://juliasilge.com/blog/reorder-within/)
```{r}
data("USArrests")
...
### TO BE ADDED
- GGally::ggpairs for correlation values, scatterplot, variable distribution view
- Heatmap using size aesthetic (use movies data from ggplot2movies package)
